...
const EquipeSearchBar: React.FC<EquipeSearchBarProps> = ({
  ...
  return (
    <div className="bg-gradient-to-r from-slate-700 to-slate-800 text-white p-6 rounded-xl shadow-xl mb-8 animate-fade-in">
      <div className="flex flex-col sm:flex-row gap-4">
        <div className="relative flex-1">
          ...
          <Input
            ...
            className="pl-12 bg-white/10 border-white/20 text-white placeholder:text-slate-300 focus:bg-white/20 focus:border-white/40 h-12 text-base backdrop-blur-sm"
          />
        </div>
        <Button
          onClick={onRefresh}
