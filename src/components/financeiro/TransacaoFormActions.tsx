...
interface TransacaoFormActionsProps {
  isEdit: boolean;
  onCancel: () => void;
  isLoading?: boolean;
}

const TransacaoFormActions: React.FC<TransacaoFormActionsProps> = ({ 
  isEdit, 
  onCancel, 
  isLoading = false 
}) => {
    ...
    <div className="p-6">
      <div className="flex justify-end gap-3">
        ...
        <Button 
          ...
          disabled={isLoading}
        >
          {isEdit ? 'Salvar Alterações' : 'Cadastrar Transação'}
        </Button>
      </div>
    </div>
  );
...
export default TransacaoFormActions;
