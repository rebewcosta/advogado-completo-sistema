...
const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="relative pt-4 pb-12 md:pt-8 md:pb-20 lg:pt-16 lg:pb-32">
        <div className="container mx-auto px-3 sm:px-4">
          
          {displayBanner && (
            <div 
              className="mb-4 sm:mb-8 p-3 sm:p-4 bg-white/10 backdrop-blur-lg rounded-xl sm:rounded-2xl border border-white/20 text-center sm:text-left shadow-2xl flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4 lg:gap-6"
              role="alertdialog"
            ...
            >
              <div className="flex items-center gap-3 sm:gap-4 flex-1 min-w-0">
                <div className="relative">
                  <img src="/icons/icon-192x192.png" alt="JusGestão" className="h-10 w-10 sm:h-12 sm:w-12 lg:h-14 lg:w-14 rounded-xl shadow-lg" />
                  <div className="absolute -top-1 -right-1 h-3 w-3 sm:h-4 sm:w-4 bg-green-400 rounded-full animate-pulse"></div>
                </div>
                <div className="min-w-0 text-left"> 
                  <h3 id="pwa-install-banner-title-hero" className="text-sm sm:text-base lg:text-lg font-bold text-white">
                    {isIOS ? "Acesso Rápido ao JusGestão" : "Instale o App JusGestão"}
                  </h3>
                  <p id="pwa-install-banner-description-hero" className="text-xs sm:text-sm text-blue-200">
                    {isIOS 
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                {!isIOS && canInstallPWA && onInstallPWA && (
                  <Button 
                    ...
                    size="sm" 
                    className="bg-green-600 hover:bg-green-700 text-white px-3 sm:px-4 py-2 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 text-xs sm:text-sm"
                  >
                    <DownloadCloud className="mr-1 sm:mr-2 h-3 w-3 sm:h-4 sm:w-4" /> Instalar App
                  </Button>
                )}
                {onDismissInstallBanner && (
                  <Button 
                    ...
                    className="text-white/70 hover:text-white hover:bg-white/10 rounded-lg transition-all duration-300 text-xs sm:text-sm"
                    aria-label="Dispensar"
                  >
                    <CloseIcon className="h-3 w-3 sm:h-4 sm:w-4 md:hidden" />
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8 sm:gap-12">
            <div className={`lg:w-7/12 text-center lg:text-left ${user ? 'lg:w-full' : ''}`}>
              {/* Badge moderno */}
              <div className="inline-flex items-center gap-2 bg-blue-600/20 border border-blue-400/30 rounded-full px-3 sm:px-4 py-2 mb-6 sm:mb-8 backdrop-blur-sm">
              ...
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-blue-100 mb-8 sm:mb-10 leading-relaxed max-w-3xl mx-auto lg:mx-0">
              ...
              {/* Stats modernos */}
              <div className="grid grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-10 max-w-sm sm:max-w-md mx-auto lg:mx-0">
                <div className="text-center">
                  <div className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-1">98%</div>
                  <div className="text-blue-300 text-xs sm:text-sm">Satisfação</div>
                </div>
                <div className="text-center">
                  <div className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-1">5k+</div>
                  <div className="text-blue-300 text-xs sm:text-sm">Advogados</div>
                </div>
                <div className="text-center">
                  <div className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-1">24/7</div>
                  <div className="text-blue-300 text-xs sm:text-sm">Suporte</div>
                </div>
              </div>

              {user && (
                <div className="flex flex-wrap gap-3 sm:gap-4 justify-center lg:justify-start">
                  <Link to="/dashboard" className="inline-flex items-center gap-2 sm:gap-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold text-base sm:text-lg shadow-2xl hover:shadow-green-500/25 transition-all duration-300 hover:scale-105 hover:from-green-500 hover:to-emerald-500">
              ...
              {/* Trust indicators */}
              <div className="flex items-center justify-center lg:justify-start gap-4 sm:gap-6 mt-6 sm:mt-8 text-blue-300">
              ...
              <div className="w-full lg:w-5/12 flex justify-center">
                <Card className="w-full max-w-md bg-white/95 backdrop-blur-lg border-0 shadow-2xl">
                  <CardHeader className="pb-3 sm:pb-4">
                    <div className="text-center">
                      <h2 className="text-xl sm:text-2xl font-bold text-gray-800 mb-2">Acesso ao Sistema</h2>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                      <div>
                        ...
                        <Input
                          ...
                          autoComplete="email"
                          required
                          className="h-11 sm:h-12 bg-white border-gray-200 focus:border-blue-500 focus:ring-blue-500 rounded-lg text-gray-800 placeholder:text-gray-400"
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          required
                          className="h-11 sm:h-12 bg-white border-gray-200 focus:border-blue-500 focus:ring-blue-500 rounded-lg text-gray-800"
                          placeholder="••••••••"
                          value={password}
