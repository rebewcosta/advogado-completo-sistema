...
const Footer = () => {
  return (
    <footer className="bg-lawyer-dark text-white py-8 mt-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Planos e Preços</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Tutoriais</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Blog Jurídico</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li>suporte@jusgestao.com.br</li>
              <li>(11) 3456-7890</li>
            ...
            <div className="mt-4">
              ...
              <div className="flex">
                ...
                />
                <button className="bg-lawyer-primary px-4 py-2 rounded-r-md hover:bg-blue-700 transition-colors">
                  Enviar
                </button>
              </div>
            </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} JusGestão - Sistema de Gestão para Advogados. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
